...
COPY --from=builder /home/opam/.opam/5.3/share/apron/lib/*.so /usr/lib/x86_64-linux-gnu/
COPY --from=builder /home/opam/.opam/5.3/share/apron/lib/*.so /usr/lib/aarch64-linux-gnu/
# Copy coar
